...
from cs336_basics.feed_forward import SwiGLU, silu
...
from cs336_basics.optimizer import AdamW, lr_cosine_schedule, gradient_clip
from cs336_basics.training_utils import data_loader, save_checkpoint, load_checkpoint
...
def run_rmsnorm(
    ...
    normalizer.load_state_dict({'norms': weights})
    return normalizer(in_features)
